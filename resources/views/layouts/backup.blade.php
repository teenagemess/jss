...
<div class="container-fluid py-5 my-5"
    ...
    <div class="container">
        <div class="row g-4 align-items-center">
            ...
            <div class="col-lg-5">
                <div class="rounded">
                    <img src="{{ asset('') }}assets/img/banner-img.jpg" class="img-fluid rounded w-100 rounded"
                        alt="">
                </div>
            </div>
        </div>
            ...
            <div class="latest-news-item">
                <div class="bg-light rounded">
                    <div class="rounded-top overflow-hidden">
                        <img src="{{ asset('') }}assets/img/news-7.jpg"
                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="lifestyle-item rounded">
                                    <img src="{{ asset('') }}assets/img/lifestyle-1.jpg"
                            ...
                            <div class="col-lg-6">
                                <div class="lifestyle-item rounded">
                                    <img src="{{ asset('') }}assets/img/lifestyle-2.jpg"
                                        class="img-fluid w-100 rounded" alt="">
                                    <div class="lifestyle-content">
                                        <div class="mt-auto">
                                            <a href="#" class="h4 text-white link-hover">There are many
                                ...
                                <div class="row g-4">
                                            ...
                                            <div class="col-4">
                                                <div class="rounded-circle position-relative">
                                                    <div class="overflow-hidden rounded-circle">
                                                        <img src="{{ asset('') }}assets/img/features-sports-1.jpg"
                                    ...
                                    <div class="col-12">
                                        <div class="row g-4 align-items-center features-item">
                                            <div class="col-4">
                                                <div class="rounded-circle position-relative">
                                                    <div class="overflow-hidden rounded-circle">
                                                        <img src="{{ asset('') }}assets/img/features-technology.jpg"
                                                            class="img-zoomin img-fluid rounded-circle w-100"
                                                            alt="">
                                                    </div>
                                                    <span
                                    ...
                                    <div class="col-12">
                                        <div class="row g-4 align-items-center features-item">
                                            <div class="col-4">
                                                <div class="rounded-circle position-relative">
                                                    <div class="overflow-hidden rounded-circle">
                                                        <img src="{{ asset('') }}assets/img/features-life-style.jpg"
                                                            class="img-zoomin img-fluid rounded-circle w-100"
                                                            alt="">
                                                    </div>
                                                    <span
                                    ...
                                    <div class="col-lg-12">
                                        <div class="position-relative banner-2">
                                            <img src="{{ asset('') }}assets/img/banner-2.jpg"
                                                class="img-fluid w-100 rounded" alt="">
