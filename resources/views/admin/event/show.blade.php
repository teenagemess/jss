    ...
    <div class="row">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-7">
                            <h4><u><b>Judul</b></u></h4>
                            <h5>{{ $dataEvent->judul }}</h5>
                        </div>
                        <div class="col-md-5">
                            <h4><u><b>Kategori</b></u></h4>
                            <h5>{{ $dataEvent->kategoris->nama }}</h5>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-7">
                            <h4><u><b>Di Buat Oleh</b></u></h4>
                            <h5>{{ $dataEvent->user_create ? $dataEvent->user_create : '-' }}</h5>
                        </div>
                        <div class="col-md-5">
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <img src="{{ asset('imageArtikel/' . $dataEvent->image) }}" alt="" width="100%">
                </div>
            </div>
        </div>
    </div>
